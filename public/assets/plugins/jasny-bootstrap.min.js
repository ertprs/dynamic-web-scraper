...
if ($(".fileinput").length != 0) {
  ...
  +(function (a) {
                  ...
                  if (!this.state) {
                      ...
                      if ((this.$element.trigger(b), !b.isDefaultPrevented())) {
                          ...
                          var c = this.getCanvasElements(),
                              ...
                              e = this.opposite(d),
                              f = this.offset();
                          -1 !== c.index(this.$element) && (a(this.$element).data("offcanvas-style", a(this.$element).attr("style") || ""), this.$element.css(d, -1 * f), this.$element.css(d)),
      ...
      +(function (a) {
          ...
          (e.DEFAULTS = { mask: "", placeholder: "_", definitions: { 9: "[0-9]", a: "[A-Za-z]", w: "[A-Za-z0-9]", "*": "." } }),
              ...
              (e.prototype.checkVal = function (a) {
                  ...
                  return (
                      !a && d + 1 < this.partialPosition ? (this.$element.val(""), this.clearBuffer(0, b)) : (a || d + 1 >= this.partialPosition) && (this.writeBuffer(), a || this.$element.val(this.$element.val().substring(0, d + 1))),
                      ...
                      (e.onload = function (b) {
                          ...
                          (e[0].src = b.target.result),
                              ...
                              "none" != f.css("max-height") &&
                                  e.css(
                                      "max-height",
                                      parseInt(f.css("max-height"), 10) - parseInt(f.css("padding-top"), 10) - parseInt(f.css("padding-bottom"), 10) - parseInt(f.css("border-top"), 10) - parseInt(f.css("border-bottom"), 10)
                                  ),
                              f.html(e),

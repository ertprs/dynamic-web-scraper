(backgroundOrange = navbar_initialized = fixedTop = !(transparentDemo = transparent = !0)), (toggle_initialized = sidebar_mini_active = !1);
...
(seq = 0),
    ...
    $(document).ready(function () {
        ...
        0 != $(".tagsinput").length && $(".tagsinput").tagsinput(),
            ...
            0 != $(".selectpicker").length && $(".selectpicker").selectpicker({ iconBase: "now-ui-icons", tickIcon: "ui-1_check" }),
            ...
            0 == $(".full-screen-map").length &&
                ...
                $(".collapse")
                    .on("show.bs.collapse", function () {
                        $(this).closest(".navbar").removeClass("navbar-white").addClass("bg-white");
                    })
                    .on("hide.bs.collapse", function () {
                        $(document).scrollTop() <= scroll_distance && $(this).closest(".navbar").addClass("navbar-white").removeClass("bg-white");
                    }),
            ...
            $(".form-file-multiple .inputFileHidden").change(function () {
                for (var a = "", e = 0; e < $(this).get(0).files.length; ++e) e < $(this).get(0).files.length - 1 ? (a += $(this).get(0).files.item(e).name + ",") : (a += $(this).get(0).files.item(e).name);
                $(this).siblings(".inputFileVisible").val(a);
            }),
            nowuiDashboard.initMinimizeSidebar(),
            0 != $(".navbar[color-on-scroll]").length && (nowuiDashboard.checkScrollForTransparentNavbar(), $(window).on("scroll", nowuiDashboard.checkScrollForTransparentNavbar)),
            $(".form-control")
                .on("focus", function () {
        ...
        (seq = seq2 = 0),
            0 == $(".full-screen-map").length &&
                ...
                $navbar.hasClass("bg-white") && 991 < $(window).width()
                    ? 0 == scrollElement.scrollTop() && $navbar.removeClass("bg-white").addClass("navbar-white")
                    : $navbar.hasClass("navbar-white") && $(window).width() < 991 && "false" != isExpanded && $navbar.addClass("bg-white").removeClass("navbar-white")),
            is_iPad && $("body").removeClass("sidebar-mini");
    }),
    (nowuiDashboard = {
        ...
        checkScrollForTransparentNavbar: debounce(function () {
            scrollElement.scrollTop() >= scroll_distance
                ? transparent && ((transparent = !1), $(".navbar[color-on-scroll]").removeClass("navbar-white").addClass("bg-white"))
                : transparent ||
                  ((transparent = !0), (0 !== $(".navbar.fixed-top .navbar-toggler[aria-expanded='false']").length || 991 < $(window).width()) && $(".navbar[color-on-scroll]").addClass("navbar-white").removeClass("bg-white"));
        }, 17),
        ...
        initMinimizeSidebar: function () {
            $("#minimizeSidebar").click(function () {
                ...
                1 == sidebar_mini_active
                    ? ($("body").removeClass("sidebar-mini"), (sidebar_mini_active = !1))
                    : ($("body").addClass("sidebar-mini"), (sidebar_mini_active = !0));
        ...
        showSidebarMessage: function (a) {
            try {
                $.notify({ icon: "now-ui-icons ui-1_bell-53", message: a }, { type: "info", timer: 4e3, placement: { from: "top", align: "right" } });
            } catch (a) {
...
new PerfectScrollbar('.table-responsive:not(.custom_table)');